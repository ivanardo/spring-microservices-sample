package user.ivanardo.orderservice.service;
...
import user.ivanardo.orderservice.event.OrderPlacedEvent;
import user.ivanardo.orderservice.model.Order;
import user.ivanardo.orderservice.model.OrderLineItems;
